...
<body>
    ...
    <section class="first-banner-part">
        ...
        <h2> Welcome to PHP</h2>    </marquee>
        <p class="first-details-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam dolore illum, temporibus veritatis
     eligendi, 
    aliquam, dolor enim itaque veniam aut eaque sequi qui quia vitae pariatur repudiandae ab dignissimos ex!</p>
    <button type="button" class="btn btn-secondary banner-button">Send Message</button>
        </div>
    </section>
    ...
    <section class="about-us-part">
        ...
        <p class="details-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam dolore illum, temporibus veritatis
     eligendi, 
    aliquam, dolor enim itaque veniam aut eaque sequi qui quia vitae pariatur repudiandae ab dignissimos ex!</p>
